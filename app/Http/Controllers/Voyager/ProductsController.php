...
class ProductsController extends VoyagerBaseController
{
    ...
    public function show(Request $request, $id)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted', 'categoriesForProduct'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $requestNew = $request;
        $requestNew['price'] =  $request->price * 100;
        $requestNew['slug'] = \Illuminate\Support\Str::slug($request->name);
