        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    <div class="panel-body" style="padding-top:0; margin-left: 15px;">
                    ...
                    @foreach($dataType->readRows as $row)
                        ...
                        <div class="panel-body" style="padding-top:0;">
                            ...
                            @else
                                @include('voyager::multilingual.input-hidden-bread-read')
                                @if ($row->display_name === 'Billing Discount' || $row->display_name === 'Billing Subtotal' || $row->display_name === 'Billing Tax'|| $row->display_name === 'Billing Total')
